...
class AppLotto:
    def __init__(self, root):
        ...
        self.seq_len_var = tk.StringVar(value="10"); self.seq_len_entry = ttk.Spinbox(self.data_params_frame, from_=2, to=100, textvariable=self.seq_len_var, width=5, wrap=True); self.seq_len_entry.grid(row=2, column=1, padx=5, pady=5, sticky=tk.W)
        ...
        ttk.Label(self.model_params_frame, text="Dropout Rate (0-1):").grid(row=3, column=0, padx=5, pady=3, sticky=tk.W); self.dropout_var = tk.StringVar(value="0.3"); self.dropout_spinbox = ttk.Spinbox(self.model_params_frame, from_=0.0, to=1.0, increment=0.05, format="%.2f", textvariable=self.dropout_var, width=7, wrap=True); self.dropout_spinbox.grid(row=3, column=1, padx=5, pady=3, sticky=tk.W)
        ...
        ttk.Label(self.model_params_frame, text="ES Min Delta:").grid(row=9, column=0, padx=5, pady=3, sticky=tk.W); self.min_delta_var = tk.StringVar(value="0.0001"); self.min_delta_entry = ttk.Entry(self.model_params_frame, textvariable=self.min_delta_var, width=10); self.min_delta_entry.grid(row=9, column=1, padx=5, pady=3, sticky=tk.W)
